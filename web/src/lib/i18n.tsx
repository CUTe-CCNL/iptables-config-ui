...
const zhTW = {
  ...
  allChains: "全部鏈",
  chainDirectory: "鏈目錄",
  chainDirectoryDescription: "依內建與自訂鏈瀏覽規則。",
  builtInChain: "內建",
  policyLabel: "政策",
  chainRuleCount: "{count} 條規則",
  noRulesInChain: "這條鏈目前沒有可編輯規則。",
  tableToolsTitle: "表格工具",
  tableToolsDescription: "管理政策、自訂鏈與新增規則。",
  columnTarget: "目標",
  columnMatch: "條件",
  columnComment: "註解",
  columnActions: "操作",
  ...
  chainBindingsTitle: "綁定到原生鏈",
  conditionalChainReference: "已由條件規則引用",
  rawChainReference: "已由 raw 規則引用",
  fieldNewChain: "新鏈名稱",
  addChain: "新增鏈",
  ...
  diagnosticsTitle: "iptables 指令診斷",
  diagnosticsDescription:
    "伺服器收集的 iptables-save、iptables -S、iptables -L 與版本輸出。",
  diagnosticsCommandCount: "{count} 個指令",
  noDiagnostics: "沒有可用的診斷輸出。",
  emptyOutput: "沒有輸出。",
  editFilterRule: "編輯 filter 規則",
  addFilterRule: "新增 filter 規則",
  filterRuleDialogDescription: "建立 filter 內建或自訂鏈的結構化 IPv4 規則。",
  addNatRule: "新增 NAT 規則",
  createNatRuleDialogDescription:
    "選擇連接埠轉發或 MASQUERADE，並填寫 NAT 規則資料。",
  natRuleDialogDescription: "修改結構化 NAT 規則。",
  fieldNatRuleType: "規則類型",
  fieldChain: "鏈",
  fieldTarget: "目標",
  fieldProtocol: "協定",
  fieldSource: "來源",
  ...
  toastNatRuleAdded: "NAT 規則已新增",
  toastNatRuleUpdated: "NAT 規則已更新",
...
const en: Record<keyof typeof zhTW, string> = {
  ...
  chainDirectory: "Chain directory",
  chainDirectoryDescription: "Browse rules by built-in and custom chain.",
  builtInChain: "built-in",
  policyLabel: "Policy",
  chainRuleCount: "{count} rule(s)",
  noRulesInChain: "No editable rules in this chain.",
  tableToolsTitle: "Table tools",
  tableToolsDescription: "Manage policies, custom chains, and new rules.",
  columnTarget: "Target",
  columnMatch: "Match",
  ...
  chainBindingsTitle: "Bind to built-in chains",
  conditionalChainReference: "referenced by conditional rule",
  rawChainReference: "referenced by raw rule",
  ...
  natRawTitle: "NAT Raw / Read-only",
  readOnlyRules: "Read-only rules",
  ...
  diagnosticsTitle: "iptables command diagnostics",
  diagnosticsDescription:
    "Server-collected iptables-save, iptables -S, iptables -L, and version output.",
  diagnosticsCommandCount: "{count} commands",
  noDiagnostics: "No diagnostics output is available.",
  ...
  createNatRuleDialogDescription:
    "Choose port forwarding or MASQUERADE, then fill in the NAT rule details.",
  natRuleDialogDescription: "Modify a structured NAT rule.",
  fieldNatRuleType: "Rule type",
  fieldChain: "Chain",
  fieldTarget: "Target",
  ...
  fieldDestinationCidr: "Destination CIDR",
  fieldToSource: "To source",
  fieldToPorts: "To ports",
  ...
  toastNatRuleAdded: "NAT rule added",
  toastNatRuleUpdated: "NAT rule updated",
